...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/dinesh__app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '6a7889e693ba9438d7f76a6a',
...
app.listen(PORT, () => {
  ...
  console.log(`dinesh  Backend Server running on port ${PORT}`);
